...
export class News extends Component {
    ...
    constructor(props){
        ...
        document.title=`${this.CapitalizeFirstLetter(this.props.category)} - SnayNews`;
    }
  ...
  render() {
    return (
        ...
        <div className="container my-3">
          <h2 className="text-center" >SnayNews - Top {this.CapitalizeFirstLetter(this.props.category)} Headlines</h2>
